...
local enUS = {
    ...
    MSG_LOADED = "Loaded. Use /sif to open the window or /sif debug to verify the runtime.",
    MSG_UNSUPPORTED = "This build targets WoW 20th Anniversary TBC Classic 2.5.x.",
    MSG_DEBUG_HEADER = "Runtime check:",
    MSG_DEBUG_LINE = "%s: %s",
    MSG_DEBUG_READY = "ready",
    MSG_DEBUG_MISSING = "missing",
    MSG_STORE_UNAVAILABLE = "SavedVariables store is not ready. Reload the UI and run /sif debug if this stays visible.",
    MSG_AH_API_MISSING = "This auction house API is not available in the current client.",
...
local es = {
    ...
    MSG_LOADED = "Cargado. Usa /sif para abrir la ventana o /sif debug para verificar el entorno.",
    MSG_UNSUPPORTED = "Esta version apunta a WoW 20 Aniversario TBC Classic 2.5.x.",
    MSG_DEBUG_HEADER = "Chequeo de entorno:",
    MSG_DEBUG_LINE = "%s: %s",
    MSG_DEBUG_READY = "ok",
    MSG_DEBUG_MISSING = "faltante",
    MSG_STORE_UNAVAILABLE = "La base local del addon no esta lista. Recarga la UI y usa /sif debug si esto sigue visible.",
    MSG_AH_API_MISSING = "La API de casa de subastas no esta disponible en este cliente.",
